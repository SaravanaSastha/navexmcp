...
export const registerReportTools = (server, ctx) => {
    server.registerTool("export_report", {
        title: "Export report",
        description: "Exports a NAVEX IRM report (by report ID from the My Reports tab) as CSV, PDF, or XLSX. Returns base64 file data. CSV exports are also returned as text for direct reading.",
        inputSchema: {
        ...
        const result = { reportId, format, contentType, fileBase64: base64 };
        if (format === "csv") {
