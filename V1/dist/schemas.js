...
export const filterSchema = z.object({
    ...
    filterType: z.enum(Object.keys(FILTER_TYPES))
...
export const fieldsRecord = z
    .record(z.any())
    .describe("Map of field name (or ID) to value. Values: string, number, boolean, null, " +
...
export function toNavexValue(v) {
    ...
    if (id !== null)
        return { Id: id };
    throw new NavexError('Invalid field value: use string, number, boolean, null, {"id": n} (1:1 lookup) or [{"id": n}] (1:many).', "VALIDATION");
}
